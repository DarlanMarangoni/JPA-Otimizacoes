...
public class Configurador extends WebMvcConfigurerAdapter {
	...
	//gerar uma instância do interceptor que será registrado. 
	@Bean
	public OpenEntityManagerInViewInterceptor getOpenEntityManagerInViewInterceptor() { 
	    return new OpenEntityManagerInViewInterceptor();
	}
	 
	//fornece um registro InterceptorRegistry que usamos para adicionar os interceptors que serão usados no SpringMVC
	@Override
